...
Homebrew is generously supported by [GitHub](https://github.com/github), [Custom Ink](https://github.com/customink), [Randy Reddig](https://github.com/ydnar), [Codecademy](https://github.com/Codecademy), [SAP](https://github.com/SAP), [b.well](https://github.com/icanbwell), [mikadelbert](https://github.com/mikadelbert), [Workbrew](https://github.com/Workbrew), [chellesand](https://github.com/chellesand) and many other users and organisations via [GitHub Sponsors](https://github.com/sponsors/Homebrew).
