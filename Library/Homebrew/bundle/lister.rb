    ...
    module Lister
      sig {
        params(entries: T::Array[Homebrew::Bundle::Dsl::Entry], formulae: T::Boolean, casks: T::Boolean,
               taps: T::Boolean, mas: T::Boolean, vscode: T::Boolean, go: T::Boolean, flatpak: T::Boolean).void
      }
      def self.list(entries, formulae:, casks:, taps:, mas:, vscode:, go:, flatpak:)
      ...
      sig {
        params(type: Symbol, formulae: T::Boolean, casks: T::Boolean, taps: T::Boolean, mas: T::Boolean,
               vscode: T::Boolean, go: T::Boolean, flatpak: T::Boolean).returns(T::Boolean)
      }
